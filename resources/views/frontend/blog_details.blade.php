                ...
                <div class="relative mx-auto minfo__contentBox max-w-container xl:max-2xl:max-w-65rem">
                    ...
                    <div class="py-3.5 max-w-content xl:max-2xl:max-w-50rem max-xl:mx-auto xl:ml-auto">
                        ...
                        <div class="px-5 py-8 bg-white md:p-8 dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                            ...
                            <div>
                                <h3 class="mb-3 text-lg font-medium text-black dark:text-white xl:text-2xl">Cappuccino Bliss
                                </h3>
                                ...
                                <br>
                                <h3 class="mb-3 text-lg font-medium text-black dark:text-white xl:text-2xl">Benifits of
                                    coffee</h3>
                                ...
                                <div class="grid gap-5 my-8 sm:grid-cols-2 md:gap-8">
                                    <div class="overflow-hidden rounded-xl xl:rounded-2xl">
                                        <img src="{{ asset('assets/frontend/assets/img/blog/article-inner2.png') }}"
                                            class="w-full" alt="Blog Inner Colum Image">
                                    </div>
                                    <div class="overflow-hidden rounded-xl xl:rounded-2xl">
                                        <img src="{{ asset('assets/frontend/assets/img/blog/article-inner1.png') }}"
                                            class="w-full" alt="Blog Inner Colum Image">
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul class="comment-list">
                                    <li class="py-4 comment">
                                        <div class="flex gap-4 author">
                                            <div class="thumb">
                                                <img src="{{ asset('assets/frontend/assets/img/blog/comment-author.png') }}"
                                                    class="rounded-full w-14 h-14" alt="Mily Martin">
                                            </div>
                                            <div class="flex-1">
                                                <h4 class="mb-1 text-lg font-medium text-black dark:text-white">Mily Martin
                                                </h4>
                                        ...
                                        <div class="description md:ml-16 md:pl-2">
                                            ...
                                            <p>
                                                <button
                                                    class="text-sm font-medium text-black dark:font-light dark:text-white"
                                                    data-te-collapse-init data-te-target="#reply_form1"
                                                    aria-label="Reply Comment">
                                                    Reply
                                                </button>
                                            </p>
                                            <form action="#" method="post" id="reply_form1"
                                                class="mt-2 !visible hidden" data-te-collapse-item>
                                                ...
                                                <div class="space-x-3 button-group text-end">
                                                    <button type="reset"
                                                        class="px-4 py-2 text-sm font-light text-black border rounded-md dark:text-white border-platinum dark:border-greyBlack dark:hover:bg-greyBlack"
                                                        aria-label="Cancel">Cancel</button>
                                                    <button type="submit"
                                                        class="px-4 py-2 text-sm font-light text-white border rounded-md border-theme bg-theme"
                                                        aria-label="Reply Comment">Reply</button>
                                                </div>
                                            </form>
                                        </div>
                                    </li>
                                    <li class="py-4 comment">
                                        <div class="flex gap-4 author">
                                            <div class="thumb">
                                                <img src="{{ asset('assets/frontend/assets/img/blog/comment-author2.png') }}"
                                                    class="rounded-full w-14 h-14" alt="Mily Martin">
                                            </div>
                                            <div class="flex-1">
                                                <h4 class="mb-1 text-lg font-medium text-black dark:text-white">Mily Martin
                                        ...
                                        <div class="description md:ml-16 md:pl-2">
                                            ...
                                            <p>
                                                <button
                                                    class="text-sm font-medium text-black dark:font-light dark:text-white"
                                                    data-te-collapse-init data-te-target="#reply_form2"
                                                    aria-label="Reply Comment">
                                                    Reply
                                                </button>
                                            </p>
                                            <form action="#" method="post" id="reply_form2"
                                                class="mt-2 !visible hidden" data-te-collapse-item>
                                                <textarea name="replyComment" rows="5"
                                                    class="w-full h-24 p-4 text-sm bg-transparent border rounded-lg outline-none resize-none border-platinum dark:border-greyBlack focus:border-theme dark:focus:border-theme"></textarea>
                                                <div class="space-x-3 button-group text-end">
                                    ...
                                    <li class="py-4 comment">
                                        ...
                                        <div class="description md:ml-16 md:pl-2">
                                            ...
                                            <p>
                                                <button
                                                    class="text-sm font-medium text-black dark:font-light dark:text-white"
                                                    data-te-collapse-init data-te-target="#reply_form3"
                                                    aria-label="Reply Comment">
                                                    Reply
                                                </button>
                                            </p>
                                            <form action="#" method="post" id="reply_form3"
                                                class="mt-2 !visible hidden" data-te-collapse-item>
                                                <textarea name="replyComment" rows="5"
                                                    class="w-full h-24 p-4 text-sm bg-transparent border rounded-lg outline-none resize-none border-platinum dark:border-greyBlack focus:border-theme dark:focus:border-theme"></textarea>
                                                <div class="space-x-3 button-group text-end">
